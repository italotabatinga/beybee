...
def main():
  ...
  while True:
      try:
          ...
          logger.debug('Captured ENVIRON: temp: {:.2f} humid: {:.2f}'.format(environ_temperature, environ_humidity))
          ...
          logger.debug('Captured HIVE: temp: {:.2f} humid: {:.2f}'.format(hive_temperature, hive_humidity))
